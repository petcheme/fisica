...
pos_x = 1*L             # posición del micrófono


# flag para grabar un archivo WAV de salida
save_wav_flag = False
...
for modo in modos:
    ...
    # el modelo es la ecuación de ondas clásica con disipación
...
# agrego la envolvente disipativa (es la misma para todos los modos!)
...
if (save_wav_flag):
    write(filename = "salida_alpha_" + str(alpha) + ".wav",
          rate=44100, data=solucion)
